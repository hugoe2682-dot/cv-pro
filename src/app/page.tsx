...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center z-10">
        <motion.div
        ...
        >
          Générez un curriculum vitae moderne, élégant et optimisé pour décrocher l'emploi de vos rêves. Facile, rapide et gratuit.
        </motion.p>
